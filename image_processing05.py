...
def display_images(image_path):
    ...
    resized_original = cv2.resize(original_image, (900, 700))
    resized_grayscale = cv2.resize(grayscale_image, (900, 700))
    ...
    cv2.imwrite('images/src/grayscale_image05.jpg', grayscale_image)
